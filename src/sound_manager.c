...
Sound_Manager* init_sound_manager()
{
	...
	s_manager->sound_crow_die[0] = LoadSound("assets/crow_die.ogg"); SetSoundVolume(s_manager->sound_crow_die[0], 0.5f);
	s_manager->sound_crow_die[1] = LoadSound("assets/crow_die.ogg"); SetSoundVolume(s_manager->sound_crow_die[1], 0.5f);
	s_manager->sound_crow_die[2] = LoadSound("assets/crow_die.ogg"); SetSoundVolume(s_manager->sound_crow_die[2], 0.5f);
